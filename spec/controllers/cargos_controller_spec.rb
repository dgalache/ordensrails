  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved cargo as @cargo" do
        ...
        post :create, {:cargo => { "tipo" => "invalid value" }}, valid_session
        assigns(:cargo).should be_a_new(Cargo)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested cargo" do
        ...
        Cargo.any_instance.should_receive(:update).with({ "tipo" => "MyString" })
        put :update, {:id => cargo.to_param, :cargo => { "tipo" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the cargo as @cargo" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Cargo.any_instance.stub(:save).and_return(false)
        put :update, {:id => cargo.to_param, :cargo => { "tipo" => "invalid value" }}, valid_session
        assigns(:cargo).should eq(cargo)
      end
